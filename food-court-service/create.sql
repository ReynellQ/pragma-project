...
create table order (id int8 not null, date date, id_chef int8, id_client int8, id_restaurant int8, state int8, primary key (id));
...
alter table if exists order add constraint FKtpnc4oe7wgffw4tdmf1ueylsk foreign key (id_chef, id_restaurant) references restaurant_employee;
...
alter table if exists order_foodplates add constraint FKar3f0m68u5kvej790b8wsrdm3 foreign key (id_order) references order;
...
create table client_order_order_food_plates (order_entity_id int8 not null, order_food_plates_id_foodplate int8 not null, order_food_plates_id_order int8 not null);
create table food_plate (id int8 not null, active boolean default true, description varchar(255), id_category int8, id_restaurant int8, name varchar(255), price int8, url_image varchar(255), primary key (id));
create table order_foodplates (id_foodplate int8 not null, id_order int8 not null, quantity int8, primary key (id_foodplate, id_order));
create table restaurant (id int8 not null, address varchar(255), id_owner int8, name varchar(255), nit int8, phone varchar(255), url_logo varchar(255), primary key (id));
create table restaurant_employee (id_restaurant int8 not null, id_user int8 not null, primary key (id_restaurant, id_user));
alter table if exists client_order_order_food_plates add constraint UK_ia41lg6lqkh6gfpinti6qsii unique (order_food_plates_id_foodplate, order_food_plates_id_order);
alter table if exists client_order add constraint FKhmn5rjwxjgn0xb2rk8xs9q3cx foreign key (id_chef, id_restaurant) references restaurant_employee;
alter table if exists client_order_order_food_plates add constraint FKakga6kkl9bg3sjvwxctcqw86x foreign key (order_food_plates_id_foodplate, order_food_plates_id_order) references order_foodplates;
alter table if exists client_order_order_food_plates add constraint FKdaypi2hs2japj7uok62hh9p6w foreign key (order_entity_id) references client_order;
alter table if exists food_plate add constraint FKgghsfm28nv9lhmg3otvmk4o9e foreign key (id_category) references category;
alter table if exists food_plate add constraint FK65t6dxfr90t0gamr7ecll7gb5 foreign key (id_restaurant) references restaurant;
alter table if exists order_foodplates add constraint FKohgu2cfqw72axdye2uimwbt4s foreign key (id_foodplate) references food_plate;
